...
use shared::responses::{
    ...
    ArchiveIndexStatusResponse, ArchiveInfoResponse, CalendarDayResponse, CalendarEventResponse,
    CreateAgentResponse, CreateApiTokenResponse, DashboardAgentLinkResponse,
    ...
    PreferencesResponse, RefreshSessionResponse, RepoQuotaResponse, RepoResponse,
    RepoTagEntryResponse, RepoWithStatsResponse, RescanResponse, RunEventResponse,
    ServerQuotaResponse, SessionListResponse, StorageRepoEntryResponse,
...
use crate::{
    api::{
        ...
        audit::{AuditLogQuery, AuditLogResponse},
...
#[openapi(
    ...
    paths(
        ...
        crate::api::repos::update_repo_power,
        ...
        crate::api::availability::update_repo_availability,
        crate::api::availability::check_repo_availability_now,
