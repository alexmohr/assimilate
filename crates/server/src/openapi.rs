...
use crate::{
    api::{
        ...
        excludes::{CreateExcludeRequest, UpdateExcludeRequest},
        logs::LogQuery,
    ...
    db::{
        ...
        RepoRow, RepoTagRow, RepoWithStatsRow, ReportRow, ScheduleRow, StorageStatRow,
        SystemEventRow, TagRow, UserRow,
    },
    ssh::{
...
#[openapi(
    ...
    paths(
        ...
        crate::api::schedules::clone_schedule,
        ...
        crate::api::excludes::delete_exclude,
