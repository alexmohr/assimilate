...
use crate::{
    api::{
        ...
        auth::{ChangePasswordRequest, LoginRequest, LoginResponse, MeResponse, RefreshResponse},
        ...
        stats::{
            DashboardAgentLink, DashboardDestination, DashboardFinding, DashboardFindingKind,
            DashboardOperation, DashboardOverviewResponse, DashboardProtectionCoverage,
            DashboardQuotaStatus, DashboardRepositoryCapacity, DashboardSeverity, DashboardStatus,
            DashboardSummaryCounters, DashboardSummaryResponse, DashboardUpcomingSchedule,
            HealthResponse, StorageRepoEntry,
        },
        system::{
    ...
    db::{
        ActivityRow, AgentRow, AgentTagRow, ApiTokenRow, GlobalExcludesConfig, RepoPermissionRow,
        RepoRow, RepoTagRow, RepoWithStatsRow, ReportRow, ScheduleCountByAgent, ScheduleRow,
...
#[openapi(
    ...
    components(schemas(
        ...
        DashboardSummaryCounters,
        DashboardFinding,
        DashboardFindingKind,
        DashboardSeverity,
        DashboardStatus,
