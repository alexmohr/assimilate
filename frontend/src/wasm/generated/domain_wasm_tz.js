/* @ts-self-types="./domain_wasm_tz.d.ts" */
 ...
 * @returns {string[]}
 */
export function nextCronRuns(expression, from, timezone, count) {
    try {
        ...
        wasm.nextCronRuns(retptr, ptr0, len0, ptr1, len1, ptr2, len2, count);
