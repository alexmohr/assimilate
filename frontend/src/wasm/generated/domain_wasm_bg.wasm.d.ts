...
export const defaultBodyTemplate: (a: number) => void;
...
export const serializeFileChangePatterns: (a: number, b: number) => void;
export const validateCron: (a: number, b: number, c: number) => void;
