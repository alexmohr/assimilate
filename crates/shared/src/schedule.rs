...
/// # Errors
///
/// Returns an error string if the cron expression is invalid or no next
/// occurrence is found.
...
/// # Errors
///
/// Returns an error string if the expression is not a valid cron pattern.
...
/// # Errors
///
/// Returns an error string if the provided timezone string is not a valid
