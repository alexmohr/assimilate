...
test.describe('Settings Journey', () => {
  ...
  test('notifications page shows webhook channel type', async ({ page }) => {
    await page.goto('/notifications');
    await page.waitForLoadState('networkidle');
  ...
  test('notifications page shows email channel type', async ({ page }) => {
    await page.goto('/notifications');
    await page.waitForLoadState('networkidle');
  ...
  test('notifications channels are enabled', async ({ page }) => {
    await page.goto('/notifications');
    await page.waitForLoadState('networkidle');
  ...
  test('tunnels page shows configured tunnel', async ({ page }) => {
  ...
  test('tunnels page shows tunnel connection details', async ({ page }) => {
    await page.goto('/tunnels');
    await page.waitForLoadState('networkidle');
