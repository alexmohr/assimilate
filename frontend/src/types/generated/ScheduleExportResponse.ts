...
import type { ScheduleRepoExportResponse } from "./ScheduleRepoExportResponse";
...
export type ScheduleExportResponse = {
   ...
   */
  pre_backup_commands: Array<HookCommand>;
  /**
   * Commands to run after the backup.
   */
  post_backup_commands: Array<HookCommand>;
  /**
   ...
   */
  repo_targets: Array<ScheduleRepoExportResponse>;
};
