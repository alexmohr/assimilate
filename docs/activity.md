...
- A backup skipped because a host was away when the run came due — either the agent being offline or the [repository's host not answering SSH](scheduling.md#skipped-backups)
